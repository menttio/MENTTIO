...
// Sustituye a salesChat. Cambios: el plan caro pasa a llamarse Completo (antes "Clase
// grabada", que nombraba una funcion y no un nivel) y desaparece la promesa del correo
// profesional, que ya no se da desde que se quitaron las cuentas corporativas.
...
- Con el plan Completo la clase se graba y aparece después sola en su ficha, sin descargar ni enviar nada. El alumno la repasa cuando quiere.
...
- Cobros: con tarjeta al reservar, o por Bizum, con el estado de cada clase a la vista de los dos.
...
- Profesores, tres opciones:
  ...
  3) Completo: 29,99 €/mes (300 € al año), todo lo de Esencial más la grabación de las clases. 14 días de prueba gratis.

NO PROMETAS NUNCA una cuenta de correo profesional ni un dominio @menttio.com: eso ya no se ofrece en ningún plan.
...
export default async function(req) {
  try {
    ...
    console.error('asistenteVentas error:', error);
