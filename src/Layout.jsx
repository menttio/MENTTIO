...
export default function Layout({ children, currentPageName }) {
  ...
  useEffect(() => {
    ...
    if (currentPageName === 'SelectRole' || currentPageName === 'Landing' || currentPageName === 'Home' || currentPageName === 'TeacherSignup' || currentPageName === 'Contact' || currentPageName === 'AboutUs' || currentPageName === 'Blog') {
      setLoading(false);
      return;
    }
