        ...
        >
          ...
          <section>
            ...
            <div className="ml-11 space-y-3">
              ...
              <p className="text-gray-600 leading-relaxed">
               <strong>Para Profesores:</strong> La suscripción está disponible en dos modalidades: Plan Esencial (12,99€/mes) y Plan Clase grabada (29,99€/mes). El Plan Clase grabada incluye la grabación y el almacenamiento de las clases; el Plan Esencial no incluye esa función. Existe además una modalidad sin cuota mensual en la que Menttio retiene un 10% de las clases cobradas a través de la plataforma. Ambos planes de suscripción incluyen 14 días de prueba gratuita al contratar por primera vez. Eres responsable de mantener tu perfil actualizado y de cumplir con las clases programadas.
              </p>
              <p className="text-gray-600 leading-relaxed">
