...
// Sustituye a salesAssistant, que prometía "grabación automática". No lo es: el profesor
// tiene que darle a grabar en Meet. Lo demás (limite por IP, precios) se mantiene igual.
